...
mixin _$BaseComponentsStylesTailorMixin
  ...
  BaseComponentsStyles lerp(
    covariant ThemeExtension<BaseComponentsStyles>? other,
    double t,
  ) {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
              posterSmallSize,
              other.posterSmallSize,
            ) &&
            const DeepCollectionEquality().equals(
              posterMediumSize,
              other.posterMediumSize,
            ) &&
            const DeepCollectionEquality().equals(
              posterLargeSize,
              other.posterLargeSize,
            ) &&
            const DeepCollectionEquality().equals(
              infoCardRatingTextStyle,
              other.infoCardRatingTextStyle,
