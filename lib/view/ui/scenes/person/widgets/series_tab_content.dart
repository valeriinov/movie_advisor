...
class SeriesTabContent extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final series = useMemoized<List<PersonSerCredData>>(
      () => _mergeCredits(seriesCredits),
      [seriesCredits],
    );
  ...
  List<PersonSerCredData> _mergeCredits(PersonCreditsSeries credits) {
    final map = <int, PersonSerCredData>{};
  ...
  String? _getGenres(List<SeriesGenre> genres) {
