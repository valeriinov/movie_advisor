...
class AuthStateMapper extends ClassMapperBase<AuthState> {
  ...
  static const Field<AuthState, AuthFormState> _f$formState = Field(
    'formState',
    _$formState,
    opt: true,
    def: const AuthFormState(),
  );
...
class _AuthStateCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({AuthFormState? formState, AuthStatus? status}) => $apply(
    FieldCopyWithData({
...
class AuthBaseStatusMapper extends ClassMapperBase<AuthBaseStatus> {
  ...
  static const Field<AuthBaseStatus, bool> _f$isLoading = Field(
    'isLoading',
    _$isLoading,
    opt: true,
    def: false,
  ...
  static const Field<AuthBaseStatus, String> _f$errorMessage = Field(
    'errorMessage',
    _$errorMessage,
    opt: true,
  );
  static bool _$isInitialized(AuthBaseStatus v) => v.isInitialized;
  static const Field<AuthBaseStatus, bool> _f$isInitialized = Field(
    'isInitialized',
    _$isInitialized,
    opt: true,
    def: false,
...
mixin AuthBaseStatusMappable {
  ...
  get copyWith => _AuthBaseStatusCopyWithImpl<AuthBaseStatus, AuthBaseStatus>(
    this as AuthBaseStatus,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return AuthBaseStatusMapper.ensureInitialized().stringifyValue(
      this as AuthBaseStatus,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return AuthBaseStatusMapper.ensureInitialized().equalsValue(
      this as AuthBaseStatus,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AuthBaseStatusMapper.ensureInitialized().hashValue(
      this as AuthBaseStatus,
    );
  }
}
...
extension AuthBaseStatusValueCopy<$R, $Out>
  ...
  AuthBaseStatusCopyWith<$R, AuthBaseStatus, $Out> get $asAuthBaseStatus =>
      $base.as((v, t, t2) => _AuthBaseStatusCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _AuthBaseStatusCopyWithImpl<$R, $Out>
  ...
  AuthBaseStatusCopyWith<$R2, AuthBaseStatus, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _AuthBaseStatusCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
...
class AuthBaseInitStatusMapper extends ClassMapperBase<AuthBaseInitStatus> {
  ...
  static const Field<AuthBaseInitStatus, bool> _f$isLoading = Field(
    'isLoading',
    _$isLoading,
    opt: true,
    def: false,
  ...
  static const Field<AuthBaseInitStatus, String> _f$errorMessage = Field(
    'errorMessage',
    _$errorMessage,
    opt: true,
  );
  static bool _$isInitialized(AuthBaseInitStatus v) => v.isInitialized;
  static const Field<AuthBaseInitStatus, bool> _f$isInitialized = Field(
    'isInitialized',
    _$isInitialized,
    opt: true,
    def: true,
...
mixin AuthBaseInitStatusMappable {
  AuthBaseInitStatusCopyWith<
    AuthBaseInitStatus,
    AuthBaseInitStatus,
    AuthBaseInitStatus
  >
  get copyWith =>
      _AuthBaseInitStatusCopyWithImpl<AuthBaseInitStatus, AuthBaseInitStatus>(
        this as AuthBaseInitStatus,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return AuthBaseInitStatusMapper.ensureInitialized().stringifyValue(
      this as AuthBaseInitStatus,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return AuthBaseInitStatusMapper.ensureInitialized().equalsValue(
      this as AuthBaseInitStatus,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AuthBaseInitStatusMapper.ensureInitialized().hashValue(
      this as AuthBaseInitStatus,
    );
  }
}
...
extension AuthBaseInitStatusValueCopy<$R, $Out>
  ...
  get $asAuthBaseInitStatus => $base.as(
    (v, t, t2) => _AuthBaseInitStatusCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class AuthBaseInitStatusCopyWith<
  $R,
  $In extends AuthBaseInitStatus,
  $Out
>
    implements ClassCopyWith<$R, $In, $Out> {
  $R call({bool? isLoading, String? errorMessage, bool? isInitialized});
...
class _AuthBaseInitStatusCopyWithImpl<$R, $Out>
  ...
  AuthBaseInitStatusCopyWith<$R2, AuthBaseInitStatus, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _AuthBaseInitStatusCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
...
class AuthSuccessStatusMapper extends ClassMapperBase<AuthSuccessStatus> {
  ...
  static const Field<AuthSuccessStatus, bool> _f$isLoading = Field(
    'isLoading',
    _$isLoading,
    opt: true,
    def: false,
  ...
  static const Field<AuthSuccessStatus, String> _f$errorMessage = Field(
    'errorMessage',
    _$errorMessage,
    opt: true,
  );
  static bool _$isInitialized(AuthSuccessStatus v) => v.isInitialized;
  static const Field<AuthSuccessStatus, bool> _f$isInitialized = Field(
    'isInitialized',
    _$isInitialized,
    opt: true,
    def: true,
...
mixin AuthSuccessStatusMappable {
  AuthSuccessStatusCopyWith<
    AuthSuccessStatus,
    AuthSuccessStatus,
    AuthSuccessStatus
  >
  get copyWith =>
      _AuthSuccessStatusCopyWithImpl<AuthSuccessStatus, AuthSuccessStatus>(
        this as AuthSuccessStatus,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return AuthSuccessStatusMapper.ensureInitialized().stringifyValue(
      this as AuthSuccessStatus,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return AuthSuccessStatusMapper.ensureInitialized().equalsValue(
      this as AuthSuccessStatus,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AuthSuccessStatusMapper.ensureInitialized().hashValue(
      this as AuthSuccessStatus,
    );
  }
}
...
extension AuthSuccessStatusValueCopy<$R, $Out>
  ...
  get $asAuthSuccessStatus => $base.as(
    (v, t, t2) => _AuthSuccessStatusCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class AuthSuccessStatusCopyWith<
  $R,
  $In extends AuthSuccessStatus,
  $Out
>
    implements ClassCopyWith<$R, $In, $Out> {
  $R call({bool? isLoading, String? errorMessage, bool? isInitialized});
...
class _AuthSuccessStatusCopyWithImpl<$R, $Out>
  ...
  AuthSuccessStatusCopyWith<$R2, AuthSuccessStatus, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _AuthSuccessStatusCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
