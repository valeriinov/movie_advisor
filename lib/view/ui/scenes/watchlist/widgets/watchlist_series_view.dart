...
class WatchlistSeriesView extends HookConsumerWidget {
  ...
  Widget build(context, ref) {
    final vsp = ref.vspFromADProvider(watchlistSeriesViewModelPr);
          ...
          return Scaffold(
            ...
            body: isSkeletonVisible
                ...
                : WatchScreenContent(
                    ...
                    emptyListSubtitle:
                        LocaleKeys.emptyWatchlistSeriesSubtitle.tr(),
                    scrollController: scrollController,
  ...
  AppPaginationState _getPaginationState(WatchlistSeriesVSP vsp) {
