...
class WatchedFilterStateMapper extends ClassMapperBase<WatchedFilterState> {
  ...
  static const Field<WatchedFilterState, dynamic> _f$filter = Field(
    'filter',
    _$filter,
    opt: true,
    arg: _arg$filter,
...
mixin WatchedFilterStateMappable<F> {
  ...
  >
  get copyWith =>
      _WatchedFilterStateCopyWithImpl<
        WatchedFilterState<F>,
        WatchedFilterState<F>,
        F
      >(this as WatchedFilterState<F>, $identity, $identity);
  @override
  String toString() {
    return WatchedFilterStateMapper.ensureInitialized().stringifyValue(
      this as WatchedFilterState<F>,
    );
  }

  @override
  bool operator ==(Object other) {
    return WatchedFilterStateMapper.ensureInitialized().equalsValue(
      this as WatchedFilterState<F>,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return WatchedFilterStateMapper.ensureInitialized().hashValue(
      this as WatchedFilterState<F>,
    );
  }
}
...
abstract class WatchedFilterStateCopyWith<
  $R,
  $In extends WatchedFilterState<F>,
  $Out,
  F
>
...
class WatchedFilterBaseStatusMapper
  ...
  static WatchedFilterBaseStatusMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = WatchedFilterBaseStatusMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<WatchedFilterBaseStatus, bool> _f$isLoading = Field(
    'isLoading',
    _$isLoading,
    opt: true,
    def: false,
  ...
  static const Field<WatchedFilterBaseStatus, String> _f$errorMessage = Field(
    'errorMessage',
    _$errorMessage,
    opt: true,
  );
  static bool _$isInitialized(WatchedFilterBaseStatus v) => v.isInitialized;
  static const Field<WatchedFilterBaseStatus, bool> _f$isInitialized = Field(
    'isInitialized',
    _$isInitialized,
    opt: true,
    def: false,
...
mixin WatchedFilterBaseStatusMappable {
  WatchedFilterBaseStatusCopyWith<
    WatchedFilterBaseStatus,
    WatchedFilterBaseStatus,
    WatchedFilterBaseStatus
  >
  get copyWith =>
      _WatchedFilterBaseStatusCopyWithImpl<
        WatchedFilterBaseStatus,
        WatchedFilterBaseStatus
      >(this as WatchedFilterBaseStatus, $identity, $identity);
  @override
  String toString() {
    return WatchedFilterBaseStatusMapper.ensureInitialized().stringifyValue(
      this as WatchedFilterBaseStatus,
    );
  }

  @override
  bool operator ==(Object other) {
    return WatchedFilterBaseStatusMapper.ensureInitialized().equalsValue(
      this as WatchedFilterBaseStatus,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return WatchedFilterBaseStatusMapper.ensureInitialized().hashValue(
      this as WatchedFilterBaseStatus,
    );
  }
}
...
extension WatchedFilterBaseStatusValueCopy<$R, $Out>
  ...
  get $asWatchedFilterBaseStatus => $base.as(
    (v, t, t2) => _WatchedFilterBaseStatusCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class WatchedFilterBaseInitStatusMapper
  ...
  static WatchedFilterBaseInitStatusMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = WatchedFilterBaseInitStatusMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<WatchedFilterBaseInitStatus, bool> _f$isLoading = Field(
    'isLoading',
    _$isLoading,
    opt: true,
    def: false,
...
mixin WatchedFilterBaseInitStatusMappable {
  WatchedFilterBaseInitStatusCopyWith<
  ...
  @override
  String toString() {
    return WatchedFilterBaseInitStatusMapper.ensureInitialized().stringifyValue(
      this as WatchedFilterBaseInitStatus,
    );
  }

  @override
  bool operator ==(Object other) {
    return WatchedFilterBaseInitStatusMapper.ensureInitialized().equalsValue(
      this as WatchedFilterBaseInitStatus,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return WatchedFilterBaseInitStatusMapper.ensureInitialized().hashValue(
      this as WatchedFilterBaseInitStatus,
    );
  }
}
...
extension WatchedFilterBaseInitStatusValueCopy<$R, $Out>
  ...
  get $asWatchedFilterBaseInitStatus => $base.as(
    (v, t, t2) => _WatchedFilterBaseInitStatusCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _WatchedFilterBaseInitStatusCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _WatchedFilterBaseInitStatusCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
...
class ApplyWatchedFilterStatusMapper
  ...
  static ApplyWatchedFilterStatusMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = ApplyWatchedFilterStatusMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<ApplyWatchedFilterStatus, bool> _f$isInitialized = Field(
    'isInitialized',
    _$isInitialized,
    opt: true,
    def: false,
...
mixin ApplyWatchedFilterStatusMappable {
  ApplyWatchedFilterStatusCopyWith<
    ApplyWatchedFilterStatus,
    ApplyWatchedFilterStatus,
    ApplyWatchedFilterStatus
  >
  get copyWith =>
      _ApplyWatchedFilterStatusCopyWithImpl<
        ApplyWatchedFilterStatus,
        ApplyWatchedFilterStatus
      >(this as ApplyWatchedFilterStatus, $identity, $identity);
  @override
  String toString() {
    return ApplyWatchedFilterStatusMapper.ensureInitialized().stringifyValue(
      this as ApplyWatchedFilterStatus,
    );
  }

  @override
  bool operator ==(Object other) {
    return ApplyWatchedFilterStatusMapper.ensureInitialized().equalsValue(
      this as ApplyWatchedFilterStatus,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ApplyWatchedFilterStatusMapper.ensureInitialized().hashValue(
      this as ApplyWatchedFilterStatus,
    );
  }
}
...
extension ApplyWatchedFilterStatusValueCopy<$R, $Out>
  ...
  get $asApplyWatchedFilterStatus => $base.as(
    (v, t, t2) => _ApplyWatchedFilterStatusCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
