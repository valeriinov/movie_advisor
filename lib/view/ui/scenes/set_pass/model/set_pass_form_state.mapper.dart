...
class SetPassFormStateMapper extends ClassMapperBase<SetPassFormState> {
  ...
  static const Field<SetPassFormState, String> _f$password =
      Field('password', _$password, opt: true, def: '');
  static String _$confirmPassword(SetPassFormState v) => v.confirmPassword;
  static const Field<SetPassFormState, String> _f$confirmPassword =
  ...
  SetPassFormStateCopyWith<SetPassFormState, SetPassFormState, SetPassFormState>
      get copyWith =>
          _SetPassFormStateCopyWithImpl<SetPassFormState, SetPassFormState>(
              this as SetPassFormState, $identity, $identity);
  @override
  String toString() {
    return SetPassFormStateMapper.ensureInitialized()
        .stringifyValue(this as SetPassFormState);
  }

  @override
  bool operator ==(Object other) {
    return SetPassFormStateMapper.ensureInitialized()
        .equalsValue(this as SetPassFormState, other);
  }

  @override
  int get hashCode {
    return SetPassFormStateMapper.ensureInitialized()
        .hashValue(this as SetPassFormState);
  }
}
...
extension SetPassFormStateValueCopy<$R, $Out>
  ...
  SetPassFormStateCopyWith<$R, SetPassFormState, $Out>
      get $asSetPassFormState => $base
          .as((v, t, t2) => _SetPassFormStateCopyWithImpl<$R, $Out>(v, t, t2));
}
