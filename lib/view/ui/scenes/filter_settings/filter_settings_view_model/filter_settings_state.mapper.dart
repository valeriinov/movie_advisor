...
class ExitFilterSettingsStatusMapper
    extends ClassMapperBase<ExitFilterSettingsStatus> {
  ExitFilterSettingsStatusMapper._();

  static ExitFilterSettingsStatusMapper? _instance;
  static ExitFilterSettingsStatusMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = ExitFilterSettingsStatusMapper._());
    }
    return _instance!;
  }

  @override
  final String id = 'ExitFilterSettingsStatus';

  static bool _$isInitialized(ExitFilterSettingsStatus v) => v.isInitialized;
  static const Field<ExitFilterSettingsStatus, bool> _f$isInitialized =
      Field('isInitialized', _$isInitialized, opt: true, def: false);

  @override
  final MappableFields<ExitFilterSettingsStatus> fields = const {
    #isInitialized: _f$isInitialized,
  };

  static ExitFilterSettingsStatus _instantiate(DecodingData data) {
    return ExitFilterSettingsStatus(isInitialized: data.dec(_f$isInitialized));
  }
...
mixin ExitFilterSettingsStatusMappable {
  ExitFilterSettingsStatusCopyWith<ExitFilterSettingsStatus,
          ExitFilterSettingsStatus, ExitFilterSettingsStatus>
      get copyWith => _ExitFilterSettingsStatusCopyWithImpl<
              ExitFilterSettingsStatus, ExitFilterSettingsStatus>(
          this as ExitFilterSettingsStatus, $identity, $identity);
  @override
  String toString() {
    return ExitFilterSettingsStatusMapper.ensureInitialized()
        .stringifyValue(this as ExitFilterSettingsStatus);
  }

  @override
  bool operator ==(Object other) {
    return ExitFilterSettingsStatusMapper.ensureInitialized()
        .equalsValue(this as ExitFilterSettingsStatus, other);
  }

  @override
  int get hashCode {
    return ExitFilterSettingsStatusMapper.ensureInitialized()
        .hashValue(this as ExitFilterSettingsStatus);
  }
}

extension ExitFilterSettingsStatusValueCopy<$R, $Out>
    on ObjectCopyWith<$R, ExitFilterSettingsStatus, $Out> {
  ExitFilterSettingsStatusCopyWith<$R, ExitFilterSettingsStatus, $Out>
      get $asExitFilterSettingsStatus => $base.as((v, t, t2) =>
          _ExitFilterSettingsStatusCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ExitFilterSettingsStatusCopyWith<
    $R,
    $In extends ExitFilterSettingsStatus,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({bool? isInitialized});
  ExitFilterSettingsStatusCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}

class _ExitFilterSettingsStatusCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, ExitFilterSettingsStatus, $Out>
    implements
        ExitFilterSettingsStatusCopyWith<$R, ExitFilterSettingsStatus, $Out> {
  _ExitFilterSettingsStatusCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ExitFilterSettingsStatus> $mapper =
      ExitFilterSettingsStatusMapper.ensureInitialized();
  @override
  $R call({bool? isInitialized}) => $apply(FieldCopyWithData(
      {if (isInitialized != null) #isInitialized: isInitialized}));
  @override
  ExitFilterSettingsStatus $make(CopyWithData data) => ExitFilterSettingsStatus(
      isInitialized: data.get(#isInitialized, or: $value.isInitialized));

  @override
  ExitFilterSettingsStatusCopyWith<$R2, ExitFilterSettingsStatus, $Out2>
      $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
          _ExitFilterSettingsStatusCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
