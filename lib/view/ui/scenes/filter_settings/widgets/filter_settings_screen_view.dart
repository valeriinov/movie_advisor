...
import 'filter_settings_content_switcher.dart';

class FilterSettingsScreenView extends HookConsumerWidget {
  ...
  Widget build(context, ref) {
    ...
    return FilterSettingsContentSwitcher(contMode: contMode);
  }
}
