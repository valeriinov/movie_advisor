...
class SetPassDataDtoMapper extends ClassMapperBase<SetPassDataDto> {
  ...
  static const Field<SetPassDataDto, String> _f$oobCode = Field(
    'oobCode',
    _$oobCode,
    key: r'oob_code',
    opt: true,
  ...
  static const Field<SetPassDataDto, String> _f$password = Field(
    'password',
    _$password,
    opt: true,
  );
...
mixin SetPassDataDtoMappable {
  String toJsonString() {
    return SetPassDataDtoMapper.ensureInitialized().encodeJson<SetPassDataDto>(
      this as SetPassDataDto,
    );
  }

  Map<String, dynamic> toJson() {
    return SetPassDataDtoMapper.ensureInitialized().encodeMap<SetPassDataDto>(
      this as SetPassDataDto,
    );
  }

  SetPassDataDtoCopyWith<SetPassDataDto, SetPassDataDto, SetPassDataDto>
  get copyWith => _SetPassDataDtoCopyWithImpl<SetPassDataDto, SetPassDataDto>(
    this as SetPassDataDto,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return SetPassDataDtoMapper.ensureInitialized().stringifyValue(
      this as SetPassDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return SetPassDataDtoMapper.ensureInitialized().equalsValue(
      this as SetPassDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SetPassDataDtoMapper.ensureInitialized().hashValue(
      this as SetPassDataDto,
    );
  }
}
...
class _SetPassDataDtoCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Object? oobCode = $none, Object? password = $none}) => $apply(
    FieldCopyWithData({
