  ...
  static SeriesWatchedFilterDataDtoMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = SeriesWatchedFilterDataDtoMapper._(),
      );
...
mixin SeriesWatchedFilterDataDtoMappable {
  ...
  SeriesWatchedFilterDataDtoCopyWith<
    SeriesWatchedFilterDataDto,
    SeriesWatchedFilterDataDto,
    SeriesWatchedFilterDataDto
  >
  get copyWith =>
      _SeriesWatchedFilterDataDtoCopyWithImpl<
        SeriesWatchedFilterDataDto,
        SeriesWatchedFilterDataDto
      >(this as SeriesWatchedFilterDataDto, $identity, $identity);
  @override
  String toString() {
    return SeriesWatchedFilterDataDtoMapper.ensureInitialized().stringifyValue(
      this as SeriesWatchedFilterDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return SeriesWatchedFilterDataDtoMapper.ensureInitialized().equalsValue(
      this as SeriesWatchedFilterDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SeriesWatchedFilterDataDtoMapper.ensureInitialized().hashValue(
      this as SeriesWatchedFilterDataDto,
    );
  }
}
...
extension SeriesWatchedFilterDataDtoValueCopy<$R, $Out>
  ...
  get $asSeriesWatchedFilterDataDto => $base.as(
    (v, t, t2) => _SeriesWatchedFilterDataDtoCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _SeriesWatchedFilterDataDtoCopyWithImpl<$R, $Out>
  ...
  @override
  SeriesWatchedFilterDataDto $make(
    CopyWithData data,
  ) => SeriesWatchedFilterDataDto(
