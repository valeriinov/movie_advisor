  ...
  static MoviesWatchedFilterDataDtoMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = MoviesWatchedFilterDataDtoMapper._(),
      );
...
mixin MoviesWatchedFilterDataDtoMappable {
  ...
  MoviesWatchedFilterDataDtoCopyWith<
    MoviesWatchedFilterDataDto,
    MoviesWatchedFilterDataDto,
    MoviesWatchedFilterDataDto
  >
  get copyWith =>
      _MoviesWatchedFilterDataDtoCopyWithImpl<
        MoviesWatchedFilterDataDto,
        MoviesWatchedFilterDataDto
      >(this as MoviesWatchedFilterDataDto, $identity, $identity);
  @override
  String toString() {
    return MoviesWatchedFilterDataDtoMapper.ensureInitialized().stringifyValue(
      this as MoviesWatchedFilterDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return MoviesWatchedFilterDataDtoMapper.ensureInitialized().equalsValue(
      this as MoviesWatchedFilterDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return MoviesWatchedFilterDataDtoMapper.ensureInitialized().hashValue(
      this as MoviesWatchedFilterDataDto,
    );
  }
}
...
extension MoviesWatchedFilterDataDtoValueCopy<$R, $Out>
  ...
  get $asMoviesWatchedFilterDataDto => $base.as(
    (v, t, t2) => _MoviesWatchedFilterDataDtoCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _MoviesWatchedFilterDataDtoCopyWithImpl<$R, $Out>
  ...
  @override
  MoviesWatchedFilterDataDto $make(
    CopyWithData data,
  ) => MoviesWatchedFilterDataDto(
