...
class SeriesFilterDataDtoMapper extends ClassMapperBase<SeriesFilterDataDto> {
  ...
  static const Field<SeriesFilterDataDto, int> _f$year = Field(
    'year',
    _$year,
    opt: true,
  );
  static SortByDto? _$sortBy(SeriesFilterDataDto v) => v.sortBy;
  static const Field<SeriesFilterDataDto, SortByDto> _f$sortBy = Field(
    'sortBy',
    _$sortBy,
    key: r'sort_by',
    opt: true,
...
mixin SeriesFilterDataDtoMappable {
  ...
  SeriesFilterDataDtoCopyWith<
    SeriesFilterDataDto,
    SeriesFilterDataDto,
    SeriesFilterDataDto
  >
  get copyWith =>
      _SeriesFilterDataDtoCopyWithImpl<
        SeriesFilterDataDto,
        SeriesFilterDataDto
      >(this as SeriesFilterDataDto, $identity, $identity);
  @override
  String toString() {
    return SeriesFilterDataDtoMapper.ensureInitialized().stringifyValue(
      this as SeriesFilterDataDto,
    );
  }

  @override
  bool operator ==(Object other) {
    return SeriesFilterDataDtoMapper.ensureInitialized().equalsValue(
      this as SeriesFilterDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SeriesFilterDataDtoMapper.ensureInitialized().hashValue(
      this as SeriesFilterDataDto,
    );
  }
}
...
abstract class SeriesFilterDataDtoCopyWith<
  $R,
  $In extends SeriesFilterDataDto,
  $Out
>
