...
class PersonSerCredDataDtoMapper extends ClassMapperBase<PersonSerCredDataDto> {
  ...
  static const Field<PersonSerCredDataDto, int> _f$id =
  ...
  static const Field<PersonSerCredDataDto, String> _f$posterPath =
...
mixin PersonSerCredDataDtoMappable {
  ...
  PersonSerCredDataDtoCopyWith<PersonSerCredDataDto, PersonSerCredDataDto,
      PersonSerCredDataDto> get copyWith => _PersonSerCredDataDtoCopyWithImpl<
          PersonSerCredDataDto, PersonSerCredDataDto>(
      this as PersonSerCredDataDto, $identity, $identity);
  @override
  String toString() {
    return PersonSerCredDataDtoMapper.ensureInitialized()
        .stringifyValue(this as PersonSerCredDataDto);
  }

  @override
  bool operator ==(Object other) {
    return PersonSerCredDataDtoMapper.ensureInitialized()
        .equalsValue(this as PersonSerCredDataDto, other);
  }

  @override
  int get hashCode {
    return PersonSerCredDataDtoMapper.ensureInitialized()
        .hashValue(this as PersonSerCredDataDto);
  }
}
