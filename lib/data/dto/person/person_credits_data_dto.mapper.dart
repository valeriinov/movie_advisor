...
class PersonCreditsDataDtoMapper extends ClassMapperBase<PersonCreditsDataDto> {
  ...
  @override
  Function get typeFactory => <T>(f) => f<PersonCreditsDataDto<T>>();

  static List<dynamic>? _$cast(PersonCreditsDataDto v) => v.cast;
  static dynamic _arg$cast<T>(f) => f<List<T>>();
  static const Field<PersonCreditsDataDto, List<dynamic>> _f$cast =
      Field('cast', _$cast, opt: true, arg: _arg$cast);
  static List<dynamic>? _$crew(PersonCreditsDataDto v) => v.crew;
  static dynamic _arg$crew<T>(f) => f<List<T>>();
  static const Field<PersonCreditsDataDto, List<dynamic>> _f$crew =
      Field('crew', _$crew, opt: true, arg: _arg$crew);
  ...
  static PersonCreditsDataDto<T> _instantiate<T>(DecodingData data) {
    return PersonCreditsDataDto(
        cast: data.dec(_f$cast), crew: data.dec(_f$crew));
  }
...
mixin PersonCreditsDataDtoMappable<T> {
  ...
  PersonCreditsDataDtoCopyWith<PersonCreditsDataDto<T>, PersonCreditsDataDto<T>,
          PersonCreditsDataDto<T>, T>
      get copyWith => _PersonCreditsDataDtoCopyWithImpl<
          PersonCreditsDataDto<T>,
          PersonCreditsDataDto<T>,
          T>(this as PersonCreditsDataDto<T>, $identity, $identity);
  @override
  String toString() {
    return PersonCreditsDataDtoMapper.ensureInitialized()
        .stringifyValue(this as PersonCreditsDataDto<T>);
  }

  @override
  bool operator ==(Object other) {
    return PersonCreditsDataDtoMapper.ensureInitialized()
        .equalsValue(this as PersonCreditsDataDto<T>, other);
  }

  @override
  int get hashCode {
    return PersonCreditsDataDtoMapper.ensureInitialized()
        .hashValue(this as PersonCreditsDataDto<T>);
  }
}
...
extension PersonCreditsDataDtoValueCopy<$R, $Out, T>
  ...
  PersonCreditsDataDtoCopyWith<$R, PersonCreditsDataDto<T>, $Out, T>
      get $asPersonCreditsDataDto => $base.as((v, t, t2) =>
          _PersonCreditsDataDtoCopyWithImpl<$R, $Out, T>(v, t, t2));
}
...
class _PersonCreditsDataDtoCopyWithImpl<$R, $Out, T>
  ...
  ListCopyWith<$R, T, ObjectCopyWith<$R, T, T>>? get cast => $value.cast != null
      ? ListCopyWith($value.cast!, (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(cast: v))
      : null;
  @override
  ListCopyWith<$R, T, ObjectCopyWith<$R, T, T>>? get crew => $value.crew != null
      ? ListCopyWith($value.crew!, (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(crew: v))
      : null;
  @override
