...
class PersonDataDtoMapper extends ClassMapperBase<PersonDataDto> {
  ...
  static const Field<PersonDataDto, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  static String? _$profilePath(PersonDataDto v) => v.profilePath;
  static const Field<PersonDataDto, String> _f$profilePath = Field(
    'profilePath',
    _$profilePath,
    key: r'profile_path',
    opt: true,
  ...
  static const Field<PersonDataDto, String> _f$placeOfBirth = Field(
    'placeOfBirth',
    _$placeOfBirth,
    key: r'place_of_birth',
    opt: true,
  );
  static GenderDto? _$gender(PersonDataDto v) => v.gender;
  static const Field<PersonDataDto, GenderDto> _f$gender = Field(
    'gender',
    _$gender,
    opt: true,
  );
  static String? _$biography(PersonDataDto v) => v.biography;
  static const Field<PersonDataDto, String> _f$biography = Field(
    'biography',
    _$biography,
    opt: true,
  );
  static DateTime? _$birthday(PersonDataDto v) => v.birthday;
  static const Field<PersonDataDto, DateTime> _f$birthday = Field(
    'birthday',
    _$birthday,
    opt: true,
    hook: DateMapperHook(),
...
mixin PersonDataDtoMappable {
  String toJsonString() {
    return PersonDataDtoMapper.ensureInitialized().encodeJson<PersonDataDto>(
      this as PersonDataDto,
    );
  }

  Map<String, dynamic> toJson() {
    return PersonDataDtoMapper.ensureInitialized().encodeMap<PersonDataDto>(
      this as PersonDataDto,
    );
  }
  ...
  @override
  String toString() {
    return PersonDataDtoMapper.ensureInitialized().stringifyValue(
      this as PersonDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return PersonDataDtoMapper.ensureInitialized().equalsValue(
      this as PersonDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PersonDataDtoMapper.ensureInitialized().hashValue(
      this as PersonDataDto,
    );
  }
}
