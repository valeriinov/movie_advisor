...
class PersonMovCredDataDtoMapper extends ClassMapperBase<PersonMovCredDataDto> {
  ...
  static const Field<PersonMovCredDataDto, int> _f$id = Field(
    'id',
    _$id,
    opt: true,
  );
  ...
  static const Field<PersonMovCredDataDto, String> _f$posterPath = Field(
    'posterPath',
    _$posterPath,
    key: r'poster_path',
    opt: true,
  ...
  static const Field<PersonMovCredDataDto, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
  );
  static double? _$popularity(PersonMovCredDataDto v) => v.popularity;
  static const Field<PersonMovCredDataDto, double> _f$popularity = Field(
    'popularity',
    _$popularity,
    opt: true,
  );
  static double? _$voteAverage(PersonMovCredDataDto v) => v.voteAverage;
  static const Field<PersonMovCredDataDto, double> _f$voteAverage = Field(
    'voteAverage',
    _$voteAverage,
    key: r'vote_average',
    opt: true,
  ...
  static const Field<PersonMovCredDataDto, int> _f$voteCount = Field(
    'voteCount',
    _$voteCount,
    key: r'vote_count',
    opt: true,
  ...
  static const Field<PersonMovCredDataDto, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    key: r'user_rating',
    opt: true,
  ...
  static const Field<PersonMovCredDataDto, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
    key: r'is_watched',
    opt: true,
  ...
  static const Field<PersonMovCredDataDto, String> _f$actCharacter = Field(
    'actCharacter',
    _$actCharacter,
    key: r'character',
    opt: true,
  ...
  static const Field<PersonMovCredDataDto, CrewJobDto> _f$crewJob = Field(
    'crewJob',
    _$crewJob,
    key: r'job',
    opt: true,
...
mixin PersonMovCredDataDtoMappable {
  ...
  PersonMovCredDataDtoCopyWith<
    PersonMovCredDataDto,
    PersonMovCredDataDto,
    PersonMovCredDataDto
  >
  get copyWith =>
      _PersonMovCredDataDtoCopyWithImpl<
        PersonMovCredDataDto,
        PersonMovCredDataDto
      >(this as PersonMovCredDataDto, $identity, $identity);
  @override
  String toString() {
    return PersonMovCredDataDtoMapper.ensureInitialized().stringifyValue(
      this as PersonMovCredDataDto,
    );
  }

  @override
  bool operator ==(Object other) {
    return PersonMovCredDataDtoMapper.ensureInitialized().equalsValue(
      this as PersonMovCredDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PersonMovCredDataDtoMapper.ensureInitialized().hashValue(
      this as PersonMovCredDataDto,
    );
  }
}
