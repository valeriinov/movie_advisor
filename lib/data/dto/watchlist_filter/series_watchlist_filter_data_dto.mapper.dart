  ...
  static SeriesWatchlistFilterDataDtoMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = SeriesWatchlistFilterDataDtoMapper._(),
      );
...
mixin SeriesWatchlistFilterDataDtoMappable {
  ...
  SeriesWatchlistFilterDataDtoCopyWith<
  ...
  bool operator ==(Object other) {
    return SeriesWatchlistFilterDataDtoMapper.ensureInitialized().equalsValue(
      this as SeriesWatchlistFilterDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SeriesWatchlistFilterDataDtoMapper.ensureInitialized().hashValue(
      this as SeriesWatchlistFilterDataDto,
    );
  }
}
...
extension SeriesWatchlistFilterDataDtoValueCopy<$R, $Out>
  ...
  get $asSeriesWatchlistFilterDataDto => $base.as(
    (v, t, t2) => _SeriesWatchlistFilterDataDtoCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _SeriesWatchlistFilterDataDtoCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _SeriesWatchlistFilterDataDtoCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
