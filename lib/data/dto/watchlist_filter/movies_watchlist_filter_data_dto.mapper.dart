  ...
  static MoviesWatchlistFilterDataDtoMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = MoviesWatchlistFilterDataDtoMapper._(),
      );
...
mixin MoviesWatchlistFilterDataDtoMappable {
  ...
  MoviesWatchlistFilterDataDtoCopyWith<
  ...
  bool operator ==(Object other) {
    return MoviesWatchlistFilterDataDtoMapper.ensureInitialized().equalsValue(
      this as MoviesWatchlistFilterDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return MoviesWatchlistFilterDataDtoMapper.ensureInitialized().hashValue(
      this as MoviesWatchlistFilterDataDto,
    );
  }
}
...
extension MoviesWatchlistFilterDataDtoValueCopy<$R, $Out>
  ...
  get $asMoviesWatchlistFilterDataDto => $base.as(
    (v, t, t2) => _MoviesWatchlistFilterDataDtoCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _MoviesWatchlistFilterDataDtoCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _MoviesWatchlistFilterDataDtoCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
