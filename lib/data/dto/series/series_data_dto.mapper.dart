...
class SeriesDataDtoMapper extends ClassMapperBase<SeriesDataDto> {
  ...
  static const Field<SeriesDataDto, String> _f$backdropPath = Field(
    'backdropPath',
    _$backdropPath,
    key: r'backdrop_path',
    opt: true,
  ...
  static const Field<SeriesDataDto, List<SeriesGenreDto>> _f$genres = Field(
    'genres',
    _$genres,
    key: r'genre_ids',
    opt: true,
  ...
  static const Field<SeriesDataDto, String> _f$originalName = Field(
    'originalName',
    _$originalName,
    key: r'original_name',
    opt: true,
  ...
  static const Field<SeriesDataDto, String> _f$overview = Field(
    'overview',
    _$overview,
    opt: true,
  );
  static double? _$popularity(SeriesDataDto v) => v.popularity;
  static const Field<SeriesDataDto, double> _f$popularity = Field(
    'popularity',
    _$popularity,
    opt: true,
  );
  static String? _$posterPath(SeriesDataDto v) => v.posterPath;
  static const Field<SeriesDataDto, String> _f$posterPath = Field(
    'posterPath',
    _$posterPath,
    key: r'poster_path',
    opt: true,
  ...
  static const Field<SeriesDataDto, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  static double? _$voteAverage(SeriesDataDto v) => v.voteAverage;
  static const Field<SeriesDataDto, double> _f$voteAverage = Field(
    'voteAverage',
    _$voteAverage,
    key: r'vote_average',
    opt: true,
  ...
  static const Field<SeriesDataDto, int> _f$voteCount = Field(
    'voteCount',
    _$voteCount,
    key: r'vote_count',
    opt: true,
  ...
  static const Field<SeriesDataDto, CreditsDataDto> _f$credits = Field(
    'credits',
    _$credits,
    opt: true,
  );
  static VideosDataDto? _$videos(SeriesDataDto v) => v.videos;
  static const Field<SeriesDataDto, VideosDataDto> _f$videos = Field(
    'videos',
    _$videos,
    opt: true,
  );
  static int? _$userRating(SeriesDataDto v) => v.userRating;
  static const Field<SeriesDataDto, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    key: r'user_rating',
    opt: true,
  ...
  static const Field<SeriesDataDto, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
    key: r'is_watched',
    opt: true,
...
mixin SeriesDataDtoMappable {
  String toJsonString() {
    return SeriesDataDtoMapper.ensureInitialized().encodeJson<SeriesDataDto>(
      this as SeriesDataDto,
    );
  }

  Map<String, dynamic> toJson() {
    return SeriesDataDtoMapper.ensureInitialized().encodeMap<SeriesDataDto>(
      this as SeriesDataDto,
    );
  }
  ...
  @override
  String toString() {
    return SeriesDataDtoMapper.ensureInitialized().stringifyValue(
      this as SeriesDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return SeriesDataDtoMapper.ensureInitialized().equalsValue(
      this as SeriesDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SeriesDataDtoMapper.ensureInitialized().hashValue(
      this as SeriesDataDto,
    );
  }
}
