...
class SeriesWatchEventDataDtoMapper
  ...
  static SeriesWatchEventDataDtoMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = SeriesWatchEventDataDtoMapper._(),
      );
  ...
  static String? _$id(SeriesWatchEventDataDto v) => v.id;
  static const Field<SeriesWatchEventDataDto, String> _f$id = Field(
    'id',
    _$id,
    opt: true,
  );
  static int? _$tmdbId(SeriesWatchEventDataDto v) => v.tmdbId;
  static const Field<SeriesWatchEventDataDto, int> _f$tmdbId = Field(
    'tmdbId',
    _$tmdbId,
    key: r'tmdb_id',
    opt: true,
  ...
  static const Field<SeriesWatchEventDataDto, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    key: r'user_rating',
    opt: true,
  ...
  static const Field<SeriesWatchEventDataDto, DateTime> _f$at = Field(
    'at',
    _$at,
    opt: true,
    hook: DateMapperHook(),
...
mixin SeriesWatchEventDataDtoMappable {
  ...
  SeriesWatchEventDataDtoCopyWith<
    SeriesWatchEventDataDto,
    SeriesWatchEventDataDto,
    SeriesWatchEventDataDto
  >
  get copyWith =>
      _SeriesWatchEventDataDtoCopyWithImpl<
        SeriesWatchEventDataDto,
        SeriesWatchEventDataDto
      >(this as SeriesWatchEventDataDto, $identity, $identity);
  @override
  String toString() {
    return SeriesWatchEventDataDtoMapper.ensureInitialized().stringifyValue(
      this as SeriesWatchEventDataDto,
    );
  }

  @override
  bool operator ==(Object other) {
    return SeriesWatchEventDataDtoMapper.ensureInitialized().equalsValue(
      this as SeriesWatchEventDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SeriesWatchEventDataDtoMapper.ensureInitialized().hashValue(
      this as SeriesWatchEventDataDto,
    );
  }
}
...
extension SeriesWatchEventDataDtoValueCopy<$R, $Out>
  ...
  get $asSeriesWatchEventDataDto => $base.as(
    (v, t, t2) => _SeriesWatchEventDataDtoCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
