...
class SeriesShortDataDtoMapper extends ClassMapperBase<SeriesShortDataDto> {
  ...
  static const Field<SeriesShortDataDto, int> _f$id = Field(
    'id',
    _$id,
    opt: true,
  );
  static String? _$posterUrl(SeriesShortDataDto v) => v.posterUrl;
  static const Field<SeriesShortDataDto, String> _f$posterUrl = Field(
    'posterUrl',
    _$posterUrl,
    key: r'poster_url',
    opt: true,
  ...
  static const Field<SeriesShortDataDto, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
  );
  static RatingDataDto? _$tmdbRating(SeriesShortDataDto v) => v.tmdbRating;
  static const Field<SeriesShortDataDto, RatingDataDto> _f$tmdbRating = Field(
    'tmdbRating',
    _$tmdbRating,
    key: r'tmdb_rating',
    opt: true,
  ...
  static const Field<SeriesShortDataDto, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    key: r'user_rating',
    opt: true,
  ...
  static const Field<SeriesShortDataDto, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
    key: r'is_watched',
    opt: true,
...
mixin SeriesShortDataDtoMappable {
  ...
  SeriesShortDataDtoCopyWith<
    SeriesShortDataDto,
    SeriesShortDataDto,
    SeriesShortDataDto
  >
  get copyWith =>
      _SeriesShortDataDtoCopyWithImpl<SeriesShortDataDto, SeriesShortDataDto>(
        this as SeriesShortDataDto,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return SeriesShortDataDtoMapper.ensureInitialized().stringifyValue(
      this as SeriesShortDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return SeriesShortDataDtoMapper.ensureInitialized().equalsValue(
      this as SeriesShortDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SeriesShortDataDtoMapper.ensureInitialized().hashValue(
      this as SeriesShortDataDto,
    );
  }
}
...
abstract class SeriesShortDataDtoCopyWith<
  $R,
  $In extends SeriesShortDataDto,
  $Out
>
