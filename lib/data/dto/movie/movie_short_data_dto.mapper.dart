...
class MovieShortDataDtoMapper extends ClassMapperBase<MovieShortDataDto> {
  ...
  static const Field<MovieShortDataDto, int> _f$id = Field(
    'id',
    _$id,
    opt: true,
  );
  static String? _$posterUrl(MovieShortDataDto v) => v.posterUrl;
  static const Field<MovieShortDataDto, String> _f$posterUrl = Field(
    'posterUrl',
    _$posterUrl,
    key: r'poster_url',
    opt: true,
  ...
  static const Field<MovieShortDataDto, List<MovieGenreDto>> _f$genres = Field(
    'genres',
    _$genres,
    opt: true,
  );
  ...
  static const Field<MovieShortDataDto, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
  );
  static RatingDataDto? _$tmdbRating(MovieShortDataDto v) => v.tmdbRating;
  static const Field<MovieShortDataDto, RatingDataDto> _f$tmdbRating = Field(
    'tmdbRating',
    _$tmdbRating,
    key: r'tmdb_rating',
    opt: true,
  ...
  static const Field<MovieShortDataDto, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    key: r'user_rating',
    opt: true,
  ...
  static const Field<MovieShortDataDto, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
    key: r'is_watched',
    opt: true,
  ...
  static const Field<MovieShortDataDto, LocalizedString> _f$localizedPosterUrl =
      Field(
        'localizedPosterUrl',
        _$localizedPosterUrl,
        key: r'localized_poster_url',
        opt: true,
      );
  static DateTime? _$watchlistAddedAt(MovieShortDataDto v) =>
      v.watchlistAddedAt;
  static const Field<MovieShortDataDto, DateTime> _f$watchlistAddedAt = Field(
    'watchlistAddedAt',
    _$watchlistAddedAt,
  ...
  static DateTime? _$lastWatchedAt(MovieShortDataDto v) => v.lastWatchedAt;
  static const Field<MovieShortDataDto, DateTime> _f$lastWatchedAt = Field(
    'lastWatchedAt',
    _$lastWatchedAt,
...
mixin MovieShortDataDtoMappable {
  ...
  get copyWith =>
      _MovieShortDataDtoCopyWithImpl<MovieShortDataDto, MovieShortDataDto>(
        this as MovieShortDataDto,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return MovieShortDataDtoMapper.ensureInitialized().stringifyValue(
      this as MovieShortDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return MovieShortDataDtoMapper.ensureInitialized().equalsValue(
      this as MovieShortDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return MovieShortDataDtoMapper.ensureInitialized().hashValue(
      this as MovieShortDataDto,
    );
  }
}
...
extension MovieShortDataDtoValueCopy<$R, $Out>
  ...
  get $asMovieShortDataDto => $base.as(
    (v, t, t2) => _MovieShortDataDtoCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class MovieShortDataDtoCopyWith<
  $R,
  $In extends MovieShortDataDto,
  $Out
>
...
class _MovieShortDataDtoCopyWithImpl<$R, $Out>
  ...
  LocalizedStringCopyWith<$R, LocalizedString, LocalizedString>?
  get localizedTitle =>
      $value.localizedTitle?.copyWith.$chain((v) => call(localizedTitle: v));
  @override
  LocalizedStringCopyWith<$R, LocalizedString, LocalizedString>?
  get localizedPosterUrl => $value.localizedPosterUrl?.copyWith.$chain(
    (v) => call(localizedPosterUrl: v),
  );
  @override
  $R call({
    Object? id = $none,
  ...
  MovieShortDataDto $make(CopyWithData data) => MovieShortDataDto(
    ...
    localizedPosterUrl: data.get(
      #localizedPosterUrl,
      or: $value.localizedPosterUrl,
    ),
