...
class MovieDataDtoMapper extends ClassMapperBase<MovieDataDto> {
  ...
  static const Field<MovieDataDto, String> _f$backdropPath = Field(
    'backdropPath',
    _$backdropPath,
    key: r'backdrop_path',
    opt: true,
  ...
  static const Field<MovieDataDto, List<MovieGenreDto>> _f$genres = Field(
    'genres',
    _$genres,
    key: r'genre_ids',
    opt: true,
  ...
  static const Field<MovieDataDto, String> _f$overview = Field(
    'overview',
    _$overview,
    opt: true,
  );
  static double? _$popularity(MovieDataDto v) => v.popularity;
  static const Field<MovieDataDto, double> _f$popularity = Field(
    'popularity',
    _$popularity,
    opt: true,
  );
  static String? _$posterPath(MovieDataDto v) => v.posterPath;
  static const Field<MovieDataDto, String> _f$posterPath = Field(
    'posterPath',
    _$posterPath,
    key: r'poster_path',
    opt: true,
  ...
  static const Field<MovieDataDto, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
  );
  static double? _$voteAverage(MovieDataDto v) => v.voteAverage;
  static const Field<MovieDataDto, double> _f$voteAverage = Field(
    'voteAverage',
    _$voteAverage,
    key: r'vote_average',
    opt: true,
  ...
  static const Field<MovieDataDto, int> _f$voteCount = Field(
    'voteCount',
    _$voteCount,
    key: r'vote_count',
    opt: true,
  ...
  static const Field<MovieDataDto, CreditsDataDto> _f$credits = Field(
    'credits',
    _$credits,
    opt: true,
  );
  static VideosDataDto? _$videos(MovieDataDto v) => v.videos;
  static const Field<MovieDataDto, VideosDataDto> _f$videos = Field(
    'videos',
    _$videos,
    opt: true,
  );
  static int? _$revenue(MovieDataDto v) => v.revenue;
  static const Field<MovieDataDto, int> _f$revenue = Field(
    'revenue',
    _$revenue,
    opt: true,
  );
  static int? _$userRating(MovieDataDto v) => v.userRating;
  static const Field<MovieDataDto, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    key: r'user_rating',
    opt: true,
  ...
  static const Field<MovieDataDto, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
    key: r'is_watched',
    opt: true,
  );
  static DateTime? _$watchlistAddedAt(MovieDataDto v) => v.watchlistAddedAt;
  static const Field<MovieDataDto, DateTime> _f$watchlistAddedAt = Field(
    'watchlistAddedAt',
    _$watchlistAddedAt,
    key: r'watchlist_added_at',
    opt: true,
    hook: DateMapperHook(),
  );
  static DateTime? _$lastWatchedAt(MovieDataDto v) => v.lastWatchedAt;
  static const Field<MovieDataDto, DateTime> _f$lastWatchedAt = Field(
    'lastWatchedAt',
    _$lastWatchedAt,
    key: r'last_watched_at',
    opt: true,
    hook: DateMapperHook(),
  );
...
mixin MovieDataDtoMappable {
  String toJsonString() {
    return MovieDataDtoMapper.ensureInitialized().encodeJson<MovieDataDto>(
      this as MovieDataDto,
    );
  }

  Map<String, dynamic> toJson() {
    return MovieDataDtoMapper.ensureInitialized().encodeMap<MovieDataDto>(
      this as MovieDataDto,
    );
  }

  MovieDataDtoCopyWith<MovieDataDto, MovieDataDto, MovieDataDto> get copyWith =>
      _MovieDataDtoCopyWithImpl<MovieDataDto, MovieDataDto>(
        this as MovieDataDto,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return MovieDataDtoMapper.ensureInitialized().stringifyValue(
      this as MovieDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return MovieDataDtoMapper.ensureInitialized().equalsValue(
      this as MovieDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return MovieDataDtoMapper.ensureInitialized().hashValue(
      this as MovieDataDto,
    );
  }
}
...
extension MovieDataDtoValueCopy<$R, $Out>
  ...
  MovieDataDtoCopyWith<$R, MovieDataDto, $Out> get $asMovieDataDto =>
      $base.as((v, t, t2) => _MovieDataDtoCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _MovieDataDtoCopyWithImpl<$R, $Out>
  ...
  MovieDataDtoCopyWith<$R2, MovieDataDto, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _MovieDataDtoCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
