...
class CastDataDtoMapper extends ClassMapperBase<CastDataDto> {
  ...
  static const Field<CastDataDto, String> _f$originalName = Field(
    'originalName',
    _$originalName,
    key: r'original_name',
    opt: true,
  ...
  static const Field<CastDataDto, String> _f$profilePath = Field(
    'profilePath',
    _$profilePath,
    key: r'profile_path',
    opt: true,
  ...
  static const Field<CastDataDto, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  static String? _$character(CastDataDto v) => v.character;
  static const Field<CastDataDto, String> _f$character = Field(
    'character',
    _$character,
    opt: true,
  );
...
mixin CastDataDtoMappable {
  String toJsonString() {
    return CastDataDtoMapper.ensureInitialized().encodeJson<CastDataDto>(
      this as CastDataDto,
    );
  }

  Map<String, dynamic> toJson() {
    return CastDataDtoMapper.ensureInitialized().encodeMap<CastDataDto>(
      this as CastDataDto,
    );
  }
  ...
  @override
  String toString() {
    return CastDataDtoMapper.ensureInitialized().stringifyValue(
      this as CastDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return CastDataDtoMapper.ensureInitialized().equalsValue(
      this as CastDataDto,
      other,
    );
  }
