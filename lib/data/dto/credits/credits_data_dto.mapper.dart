...
class CreditsDataDtoMapper extends ClassMapperBase<CreditsDataDto> {
  ...
  static const Field<CreditsDataDto, List<CastDataDto>> _f$cast = Field(
    'cast',
    _$cast,
    opt: true,
  );
  static List<CrewDataDto>? _$crew(CreditsDataDto v) => v.crew;
  static const Field<CreditsDataDto, List<CrewDataDto>> _f$crew = Field(
    'crew',
    _$crew,
    opt: true,
  );
...
mixin CreditsDataDtoMappable {
  String toJsonString() {
    return CreditsDataDtoMapper.ensureInitialized().encodeJson<CreditsDataDto>(
      this as CreditsDataDto,
    );
  }

  Map<String, dynamic> toJson() {
    return CreditsDataDtoMapper.ensureInitialized().encodeMap<CreditsDataDto>(
      this as CreditsDataDto,
    );
  }

  CreditsDataDtoCopyWith<CreditsDataDto, CreditsDataDto, CreditsDataDto>
  get copyWith => _CreditsDataDtoCopyWithImpl<CreditsDataDto, CreditsDataDto>(
    this as CreditsDataDto,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return CreditsDataDtoMapper.ensureInitialized().stringifyValue(
      this as CreditsDataDto,
    );
  }
  ...
  bool operator ==(Object other) {
    return CreditsDataDtoMapper.ensureInitialized().equalsValue(
      this as CreditsDataDto,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return CreditsDataDtoMapper.ensureInitialized().hashValue(
      this as CreditsDataDto,
    );
  }
}
