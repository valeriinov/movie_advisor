...
class ListWithPaginationDataMapper
  ...
  Function get typeFactory =>
      <T>(f) => f<ListWithPaginationData<T>>();

  static List<dynamic> _$items(ListWithPaginationData v) => v.items;
  static dynamic _arg$items<T>(f) => f<List<T>>();
  static const Field<ListWithPaginationData, List<dynamic>> _f$items = Field(
    'items',
    _$items,
    arg: _arg$items,
  );
  static int _$currentPage(ListWithPaginationData v) => v.currentPage;
  static const Field<ListWithPaginationData, int> _f$currentPage = Field(
    'currentPage',
    _$currentPage,
    opt: true,
    def: -1,
  ...
  static const Field<ListWithPaginationData, bool> _f$isLastPage = Field(
    'isLastPage',
    _$isLastPage,
    opt: true,
    def: true,
...
mixin ListWithPaginationDataMappable<T> {
  ...
  >
  get copyWith =>
      _ListWithPaginationDataCopyWithImpl<
        ListWithPaginationData<T>,
        ListWithPaginationData<T>,
        T
  ...
  @override
  String toString() {
    return ListWithPaginationDataMapper.ensureInitialized().stringifyValue(
      this as ListWithPaginationData<T>,
    );
  }

  @override
  bool operator ==(Object other) {
    return ListWithPaginationDataMapper.ensureInitialized().equalsValue(
      this as ListWithPaginationData<T>,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ListWithPaginationDataMapper.ensureInitialized().hashValue(
      this as ListWithPaginationData<T>,
    );
  }
}
...
extension ListWithPaginationDataValueCopy<$R, $Out, T>
  ...
  get $asListWithPaginationData => $base.as(
    (v, t, t2) => _ListWithPaginationDataCopyWithImpl<$R, $Out, T>(v, t, t2),
  );
}
...
class _ListWithPaginationDataCopyWithImpl<$R, $Out, T>
  ...
  @override
  $R call({List<T>? items, int? currentPage, bool? isLastPage}) => $apply(
    FieldCopyWithData({
