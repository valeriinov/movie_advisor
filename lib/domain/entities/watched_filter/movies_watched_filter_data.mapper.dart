...
class MoviesWatchedFilterDataMapper
  ...
  static MoviesWatchedFilterDataMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = MoviesWatchedFilterDataMapper._(),
      );
  ...
  static const Field<MoviesWatchedFilterData, WatchedSortBy> _f$sortBy = Field(
    'sortBy',
    _$sortBy,
    opt: true,
  ...
  static bool _$includeWatchlist(MoviesWatchedFilterData v) =>
      v.includeWatchlist;
  static const Field<MoviesWatchedFilterData, bool> _f$includeWatchlist = Field(
    'includeWatchlist',
    _$includeWatchlist,
    opt: true,
    def: true,
...
mixin MoviesWatchedFilterDataMappable {
  MoviesWatchedFilterDataCopyWith<
    MoviesWatchedFilterData,
    MoviesWatchedFilterData,
    MoviesWatchedFilterData
  >
  get copyWith =>
      _MoviesWatchedFilterDataCopyWithImpl<
        MoviesWatchedFilterData,
        MoviesWatchedFilterData
      >(this as MoviesWatchedFilterData, $identity, $identity);
  @override
  String toString() {
    return MoviesWatchedFilterDataMapper.ensureInitialized().stringifyValue(
      this as MoviesWatchedFilterData,
    );
  }

  @override
  bool operator ==(Object other) {
    return MoviesWatchedFilterDataMapper.ensureInitialized().equalsValue(
      this as MoviesWatchedFilterData,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return MoviesWatchedFilterDataMapper.ensureInitialized().hashValue(
      this as MoviesWatchedFilterData,
    );
  }
}
...
extension MoviesWatchedFilterDataValueCopy<$R, $Out>
  ...
  get $asMoviesWatchedFilterData => $base.as(
    (v, t, t2) => _MoviesWatchedFilterDataCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
