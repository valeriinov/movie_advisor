...
class WatchedFilterDataMapper extends ClassMapperBase<WatchedFilterData> {
  ...
  static const Field<WatchedFilterData, WatchedSortBy> _f$sortBy = Field(
    'sortBy',
    _$sortBy,
  );
  static List<Country> _$withCountries(WatchedFilterData v) => v.withCountries;
  static const Field<WatchedFilterData, List<Country>> _f$withCountries = Field(
    'withCountries',
    _$withCountries,
  );
  static bool _$includeWatchlist(WatchedFilterData v) => v.includeWatchlist;
  static const Field<WatchedFilterData, bool> _f$includeWatchlist = Field(
    'includeWatchlist',
    _$includeWatchlist,
  );
  static DateTime? _$fromPremiereDate(WatchedFilterData v) =>
      v.fromPremiereDate;
  static const Field<WatchedFilterData, DateTime> _f$fromPremiereDate = Field(
    'fromPremiereDate',
    _$fromPremiereDate,
    opt: true,
  );
  static DateTime? _$toPremiereDate(WatchedFilterData v) => v.toPremiereDate;
  static const Field<WatchedFilterData, DateTime> _f$toPremiereDate = Field(
    'toPremiereDate',
    _$toPremiereDate,
    opt: true,
  );
  static DateTime? _$fromWatchedDate(WatchedFilterData v) => v.fromWatchedDate;
  static const Field<WatchedFilterData, DateTime> _f$fromWatchedDate = Field(
    'fromWatchedDate',
    _$fromWatchedDate,
    opt: true,
  );
  static DateTime? _$toWatchedDate(WatchedFilterData v) => v.toWatchedDate;
  static const Field<WatchedFilterData, DateTime> _f$toWatchedDate = Field(
    'toWatchedDate',
    _$toWatchedDate,
    opt: true,
  );
...
mixin WatchedFilterDataMappable {
  ...
  get copyWith =>
      _WatchedFilterDataCopyWithImpl<WatchedFilterData, WatchedFilterData>(
        this as WatchedFilterData,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return WatchedFilterDataMapper.ensureInitialized().stringifyValue(
      this as WatchedFilterData,
    );
  }
  ...
  bool operator ==(Object other) {
    return WatchedFilterDataMapper.ensureInitialized().equalsValue(
      this as WatchedFilterData,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return WatchedFilterDataMapper.ensureInitialized().hashValue(
      this as WatchedFilterData,
    );
  }
}
...
extension WatchedFilterDataValueCopy<$R, $Out>
  ...
  get $asWatchedFilterData => $base.as(
    (v, t, t2) => _WatchedFilterDataCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class WatchedFilterDataCopyWith<
  $R,
  $In extends WatchedFilterData,
  $Out
>
