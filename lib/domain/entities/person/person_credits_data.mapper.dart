...
class PersonCreditsDataMapper extends ClassMapperBase<PersonCreditsData> {
  ...
  @override
  Function get typeFactory => <T>(f) => f<PersonCreditsData<T>>();

  static List<dynamic> _$cast(PersonCreditsData v) => v.cast;
  static dynamic _arg$cast<T>(f) => f<List<T>>();
  static const Field<PersonCreditsData, List<dynamic>> _f$cast =
      Field('cast', _$cast, opt: true, def: const [], arg: _arg$cast);
  static List<dynamic> _$crew(PersonCreditsData v) => v.crew;
  static dynamic _arg$crew<T>(f) => f<List<T>>();
  static const Field<PersonCreditsData, List<dynamic>> _f$crew =
      Field('crew', _$crew, opt: true, def: const [], arg: _arg$crew);
...
mixin PersonCreditsDataMappable<T> {
  PersonCreditsDataCopyWith<PersonCreditsData<T>, PersonCreditsData<T>,
          PersonCreditsData<T>, T>
      get copyWith => _PersonCreditsDataCopyWithImpl<
          PersonCreditsData<T>,
          PersonCreditsData<T>,
          T>(this as PersonCreditsData<T>, $identity, $identity);
  @override
  String toString() {
    return PersonCreditsDataMapper.ensureInitialized()
        .stringifyValue(this as PersonCreditsData<T>);
  }

  @override
  bool operator ==(Object other) {
    return PersonCreditsDataMapper.ensureInitialized()
        .equalsValue(this as PersonCreditsData<T>, other);
  }

  @override
  int get hashCode {
    return PersonCreditsDataMapper.ensureInitialized()
        .hashValue(this as PersonCreditsData<T>);
  }
}
...
abstract class PersonCreditsDataCopyWith<$R, $In extends PersonCreditsData<T>,
...
class _PersonCreditsDataCopyWithImpl<$R, $Out, T>
  ...
  ListCopyWith<$R, T, ObjectCopyWith<$R, T, T>> get crew => ListCopyWith(
      ...
      (v) => call(crew: v));
  @override
  $R call({List<T>? cast, List<T>? crew}) => $apply(FieldCopyWithData(
      {if (cast != null) #cast: cast, if (crew != null) #crew: crew}));
  @override
