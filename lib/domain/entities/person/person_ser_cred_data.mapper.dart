...
class PersonSerCredDataMapper extends ClassMapperBase<PersonSerCredData> {
  ...
  static const Field<PersonSerCredData, int> _f$id = Field(
    'id',
    _$id,
    opt: true,
    def: -1,
  ...
  static const Field<PersonSerCredData, String> _f$posterUrl = Field(
    'posterUrl',
    _$posterUrl,
    opt: true,
    def: '',
  ...
  static const Field<PersonSerCredData, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
    def: '',
  ...
  static const Field<PersonSerCredData, List<SeriesGenre>> _f$genres = Field(
    'genres',
    _$genres,
    opt: true,
    def: const [],
  ...
  static const Field<PersonSerCredData, DateTime> _f$premiereDate = Field(
    'premiereDate',
    _$premiereDate,
    opt: true,
  );
  static TMDBRating _$tmdbRating(PersonSerCredData v) => v.tmdbRating;
  static const Field<PersonSerCredData, TMDBRating> _f$tmdbRating = Field(
    'tmdbRating',
    _$tmdbRating,
    opt: true,
  ...
  static const Field<PersonSerCredData, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    opt: true,
    def: 0,
  ...
  static const Field<PersonSerCredData, bool> _f$isInWatchlist = Field(
    'isInWatchlist',
    _$isInWatchlist,
    opt: true,
    def: false,
  ...
  static const Field<PersonSerCredData, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
    opt: true,
    def: false,
  ...
  static const Field<PersonSerCredData, String> _f$actCharacter = Field(
    'actCharacter',
    _$actCharacter,
    opt: true,
  );
  static CrewJob? _$crewJob(PersonSerCredData v) => v.crewJob;
  static const Field<PersonSerCredData, CrewJob> _f$crewJob = Field(
    'crewJob',
    _$crewJob,
    opt: true,
  );
...
mixin PersonSerCredDataMappable {
  ...
  get copyWith =>
      _PersonSerCredDataCopyWithImpl<PersonSerCredData, PersonSerCredData>(
        this as PersonSerCredData,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PersonSerCredDataMapper.ensureInitialized().stringifyValue(
      this as PersonSerCredData,
    );
  }
  ...
  bool operator ==(Object other) {
    return PersonSerCredDataMapper.ensureInitialized().equalsValue(
      this as PersonSerCredData,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PersonSerCredDataMapper.ensureInitialized().hashValue(
      this as PersonSerCredData,
    );
  }
}
...
extension PersonSerCredDataValueCopy<$R, $Out>
  ...
  get $asPersonSerCredData => $base.as(
    (v, t, t2) => _PersonSerCredDataCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class PersonSerCredDataCopyWith<
  $R,
  $In extends PersonSerCredData,
  $Out
>
