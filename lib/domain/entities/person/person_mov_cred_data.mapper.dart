...
class PersonMovCredDataMapper extends ClassMapperBase<PersonMovCredData> {
  ...
  static const Field<PersonMovCredData, int> _f$id = Field(
    'id',
    _$id,
    opt: true,
    def: -1,
  ...
  static const Field<PersonMovCredData, String> _f$posterUrl = Field(
    'posterUrl',
    _$posterUrl,
    opt: true,
    def: '',
  ...
  static const Field<PersonMovCredData, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
    def: '',
  ...
  static const Field<PersonMovCredData, List<MovieGenre>> _f$genres = Field(
    'genres',
    _$genres,
    opt: true,
    def: const [],
  ...
  static const Field<PersonMovCredData, DateTime> _f$premiereDate = Field(
    'premiereDate',
    _$premiereDate,
    opt: true,
  );
  static TMDBRating _$tmdbRating(PersonMovCredData v) => v.tmdbRating;
  static const Field<PersonMovCredData, TMDBRating> _f$tmdbRating = Field(
    'tmdbRating',
    _$tmdbRating,
    opt: true,
  ...
  static const Field<PersonMovCredData, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    opt: true,
    def: 0,
  ...
  static const Field<PersonMovCredData, bool> _f$isInWatchlist = Field(
    'isInWatchlist',
    _$isInWatchlist,
    opt: true,
    def: false,
  ...
  static const Field<PersonMovCredData, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
    opt: true,
    def: false,
  ...
  static const Field<PersonMovCredData, String> _f$actCharacter = Field(
    'actCharacter',
    _$actCharacter,
    opt: true,
  );
  static CrewJob? _$crewJob(PersonMovCredData v) => v.crewJob;
  static const Field<PersonMovCredData, CrewJob> _f$crewJob = Field(
    'crewJob',
    _$crewJob,
    opt: true,
  );
...
mixin PersonMovCredDataMappable {
  ...
  get copyWith =>
      _PersonMovCredDataCopyWithImpl<PersonMovCredData, PersonMovCredData>(
        this as PersonMovCredData,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PersonMovCredDataMapper.ensureInitialized().stringifyValue(
      this as PersonMovCredData,
    );
  }
  ...
  bool operator ==(Object other) {
    return PersonMovCredDataMapper.ensureInitialized().equalsValue(
      this as PersonMovCredData,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return PersonMovCredDataMapper.ensureInitialized().hashValue(
      this as PersonMovCredData,
    );
  }
}
...
extension PersonMovCredDataValueCopy<$R, $Out>
  ...
  get $asPersonMovCredData => $base.as(
    (v, t, t2) => _PersonMovCredDataCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class PersonMovCredDataCopyWith<
  $R,
  $In extends PersonMovCredData,
  $Out
>
