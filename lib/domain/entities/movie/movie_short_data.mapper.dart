...
class MovieShortDataMapper extends ClassMapperBase<MovieShortData> {
  ...
  static const Field<MovieShortData, int> _f$id = Field(
    'id',
    _$id,
    opt: true,
    def: -1,
  ...
  static const Field<MovieShortData, String> _f$posterUrl = Field(
    'posterUrl',
    _$posterUrl,
    opt: true,
    def: '',
  ...
  static const Field<MovieShortData, List<MovieGenre>> _f$genres = Field(
    'genres',
    _$genres,
    opt: true,
    def: const [],
  ...
  static const Field<MovieShortData, List<Country>> _f$originCountry = Field(
    'originCountry',
    _$originCountry,
    opt: true,
    def: const [],
  ...
  static const Field<MovieShortData, DateTime> _f$premiereDate = Field(
    'premiereDate',
    _$premiereDate,
    opt: true,
  );
  static String _$title(MovieShortData v) => v.title;
  static const Field<MovieShortData, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
    def: '',
  ...
  static const Field<MovieShortData, TMDBRating> _f$tmdbRating = Field(
    'tmdbRating',
    _$tmdbRating,
    opt: true,
  ...
  static const Field<MovieShortData, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    opt: true,
    def: 0,
  ...
  static const Field<MovieShortData, bool> _f$isInWatchlist = Field(
    'isInWatchlist',
    _$isInWatchlist,
    opt: true,
    def: false,
  ...
  static const Field<MovieShortData, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
    opt: true,
    def: false,
  );
  static DateTime? _$watchlistAddedAt(MovieShortData v) => v.watchlistAddedAt;
  static const Field<MovieShortData, DateTime> _f$watchlistAddedAt = Field(
    'watchlistAddedAt',
    _$watchlistAddedAt,
    opt: true,
  );
  static DateTime? _$lastWatchedAt(MovieShortData v) => v.lastWatchedAt;
  static const Field<MovieShortData, DateTime> _f$lastWatchedAt = Field(
    'lastWatchedAt',
    _$lastWatchedAt,
    opt: true,
  );
...
mixin MovieShortDataMappable {
  ...
  get copyWith => _MovieShortDataCopyWithImpl<MovieShortData, MovieShortData>(
    this as MovieShortData,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return MovieShortDataMapper.ensureInitialized().stringifyValue(
      this as MovieShortData,
    );
  }
  ...
  bool operator ==(Object other) {
    return MovieShortDataMapper.ensureInitialized().equalsValue(
      this as MovieShortData,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return MovieShortDataMapper.ensureInitialized().hashValue(
      this as MovieShortData,
    );
  }
}
