...
class MovieDataMapper extends ClassMapperBase<MovieData> {
  ...
  static const Field<MovieData, int> _f$id = Field(
    'id',
    _$id,
    opt: true,
    def: -1,
  ...
  static const Field<MovieData, String> _f$backdropUrl = Field(
    'backdropUrl',
    _$backdropUrl,
    opt: true,
    def: '',
  ...
  static const Field<MovieData, String> _f$posterUrl = Field(
    'posterUrl',
    _$posterUrl,
    opt: true,
    def: '',
  ...
  static const Field<MovieData, List<MovieGenre>> _f$genres = Field(
    'genres',
    _$genres,
    opt: true,
    def: const [],
  ...
  static const Field<MovieData, List<Country>> _f$originCountry = Field(
    'originCountry',
    _$originCountry,
    opt: true,
    def: const [],
  ...
  static const Field<MovieData, String> _f$originalLanguage = Field(
    'originalLanguage',
    _$originalLanguage,
    opt: true,
    def: '',
  ...
  static const Field<MovieData, String> _f$originalTitle = Field(
    'originalTitle',
    _$originalTitle,
    opt: true,
    def: '',
  ...
  static const Field<MovieData, DateTime> _f$premiereDate = Field(
    'premiereDate',
    _$premiereDate,
    opt: true,
  );
  static String _$title(MovieData v) => v.title;
  static const Field<MovieData, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
    def: '',
  ...
  static const Field<MovieData, String> _f$overview = Field(
    'overview',
    _$overview,
    opt: true,
    def: '',
  ...
  static const Field<MovieData, TMDBRating> _f$tmdbRating = Field(
    'tmdbRating',
    _$tmdbRating,
    opt: true,
  ...
  static const Field<MovieData, List<CastData>> _f$cast = Field(
    'cast',
    _$cast,
    opt: true,
    def: const [],
  ...
  static const Field<MovieData, List<CrewData>> _f$crew = Field(
    'crew',
    _$crew,
    opt: true,
    def: const [],
  ...
  static const Field<MovieData, List<VideoData>> _f$videos = Field(
    'videos',
    _$videos,
    opt: true,
    def: const [],
  ...
  static const Field<MovieData, int> _f$revenue = Field(
    'revenue',
    _$revenue,
    opt: true,
    def: 0,
  ...
  static const Field<MovieData, int> _f$userRating = Field(
    'userRating',
    _$userRating,
    opt: true,
    def: 0,
  ...
  static const Field<MovieData, bool> _f$isInWatchlist = Field(
    'isInWatchlist',
    _$isInWatchlist,
    opt: true,
    def: false,
  ...
  static const Field<MovieData, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
    opt: true,
    def: false,
  ...
  static const Field<MovieData, DateTime> _f$watchlistAddedAt = Field(
    'watchlistAddedAt',
    _$watchlistAddedAt,
    opt: true,
  );
  static DateTime? _$lastWatchedAt(MovieData v) => v.lastWatchedAt;
  static const Field<MovieData, DateTime> _f$lastWatchedAt = Field(
    'lastWatchedAt',
    _$lastWatchedAt,
    opt: true,
  );
...
mixin MovieDataMappable {
  ...
  @override
  String toString() {
    return MovieDataMapper.ensureInitialized().stringifyValue(
      this as MovieData,
    );
  }
  ...
  bool operator ==(Object other) {
    return MovieDataMapper.ensureInitialized().equalsValue(
      this as MovieData,
      other,
    );
  }
