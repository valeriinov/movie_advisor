...
class WatchlistFilterDataMapper extends ClassMapperBase<WatchlistFilterData> {
  ...
  static const Field<WatchlistFilterData, WatchlistSortBy> _f$sortBy = Field(
    'sortBy',
    _$sortBy,
  );
  ...
  static const Field<WatchlistFilterData, bool> _f$includeWatched = Field(
    'includeWatched',
    _$includeWatched,
  );
  static DateTime? _$fromPremiereDate(WatchlistFilterData v) =>
      v.fromPremiereDate;
  static const Field<WatchlistFilterData, DateTime> _f$fromPremiereDate = Field(
    'fromPremiereDate',
    _$fromPremiereDate,
    opt: true,
  );
  static DateTime? _$toPremiereDate(WatchlistFilterData v) => v.toPremiereDate;
  static const Field<WatchlistFilterData, DateTime> _f$toPremiereDate = Field(
    'toPremiereDate',
    _$toPremiereDate,
    opt: true,
  );
  static DateTime? _$fromAddedDate(WatchlistFilterData v) => v.fromAddedDate;
  static const Field<WatchlistFilterData, DateTime> _f$fromAddedDate = Field(
    'fromAddedDate',
    _$fromAddedDate,
    opt: true,
  );
  static DateTime? _$toAddedDate(WatchlistFilterData v) => v.toAddedDate;
  static const Field<WatchlistFilterData, DateTime> _f$toAddedDate = Field(
    'toAddedDate',
    _$toAddedDate,
    opt: true,
  );
...
mixin WatchlistFilterDataMappable {
  WatchlistFilterDataCopyWith<
    WatchlistFilterData,
    WatchlistFilterData,
    WatchlistFilterData
  >
  get copyWith =>
      _WatchlistFilterDataCopyWithImpl<
        WatchlistFilterData,
        WatchlistFilterData
      >(this as WatchlistFilterData, $identity, $identity);
  @override
  String toString() {
    return WatchlistFilterDataMapper.ensureInitialized().stringifyValue(
      this as WatchlistFilterData,
    );
  }

  @override
  bool operator ==(Object other) {
    return WatchlistFilterDataMapper.ensureInitialized().equalsValue(
      this as WatchlistFilterData,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return WatchlistFilterDataMapper.ensureInitialized().hashValue(
      this as WatchlistFilterData,
    );
  }
}
...
abstract class WatchlistFilterDataCopyWith<
  $R,
  $In extends WatchlistFilterData,
  $Out
>
