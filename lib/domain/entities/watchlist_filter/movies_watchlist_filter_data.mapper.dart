...
class MoviesWatchlistFilterDataMapper
  ...
  static MoviesWatchlistFilterDataMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = MoviesWatchlistFilterDataMapper._(),
      );
  ...
  static const Field<MoviesWatchlistFilterData, bool> _f$includeWatched = Field(
    'includeWatched',
    _$includeWatched,
    opt: true,
    def: true,
...
mixin MoviesWatchlistFilterDataMappable {
  MoviesWatchlistFilterDataCopyWith<
    MoviesWatchlistFilterData,
    MoviesWatchlistFilterData,
    MoviesWatchlistFilterData
  >
  get copyWith =>
      _MoviesWatchlistFilterDataCopyWithImpl<
        MoviesWatchlistFilterData,
        MoviesWatchlistFilterData
      >(this as MoviesWatchlistFilterData, $identity, $identity);
  @override
  String toString() {
    return MoviesWatchlistFilterDataMapper.ensureInitialized().stringifyValue(
      this as MoviesWatchlistFilterData,
    );
  }

  @override
  bool operator ==(Object other) {
    return MoviesWatchlistFilterDataMapper.ensureInitialized().equalsValue(
      this as MoviesWatchlistFilterData,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return MoviesWatchlistFilterDataMapper.ensureInitialized().hashValue(
      this as MoviesWatchlistFilterData,
    );
  }
}
...
extension MoviesWatchlistFilterDataValueCopy<$R, $Out>
  ...
  get $asMoviesWatchlistFilterData => $base.as(
    (v, t, t2) => _MoviesWatchlistFilterDataCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
