...
class SeriesWatchlistFilterDataMapper
  ...
  static SeriesWatchlistFilterDataMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = SeriesWatchlistFilterDataMapper._(),
      );
  ...
  static const Field<SeriesWatchlistFilterData, bool> _f$includeWatched = Field(
    'includeWatched',
    _$includeWatched,
    opt: true,
    def: true,
  ...
  _f$withGenres = Field('withGenres', _$withGenres, opt: true, def: const []);
...
mixin SeriesWatchlistFilterDataMappable {
  SeriesWatchlistFilterDataCopyWith<
    SeriesWatchlistFilterData,
    SeriesWatchlistFilterData,
    SeriesWatchlistFilterData
  >
  get copyWith =>
      _SeriesWatchlistFilterDataCopyWithImpl<
        SeriesWatchlistFilterData,
        SeriesWatchlistFilterData
      >(this as SeriesWatchlistFilterData, $identity, $identity);
  @override
  String toString() {
    return SeriesWatchlistFilterDataMapper.ensureInitialized().stringifyValue(
      this as SeriesWatchlistFilterData,
    );
  }

  @override
  bool operator ==(Object other) {
    return SeriesWatchlistFilterDataMapper.ensureInitialized().equalsValue(
      this as SeriesWatchlistFilterData,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SeriesWatchlistFilterDataMapper.ensureInitialized().hashValue(
      this as SeriesWatchlistFilterData,
    );
  }
}
...
extension SeriesWatchlistFilterDataValueCopy<$R, $Out>
  ...
  get $asSeriesWatchlistFilterData => $base.as(
    (v, t, t2) => _SeriesWatchlistFilterDataCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
abstract class SeriesWatchlistFilterDataCopyWith<
  ...
  $Out
>
    implements WatchlistFilterDataCopyWith<$R, $In, $Out> {
  @override
...
class _SeriesWatchlistFilterDataCopyWithImpl<$R, $Out>
  ...
  SeriesWatchlistFilterData $make(CopyWithData data) =>
      SeriesWatchlistFilterData(
        ...
        fromPremiereDate: data.get(
          #fromPremiereDate,
          or: $value.fromPremiereDate,
        ),
