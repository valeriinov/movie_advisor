...
class MediaDataMapper extends ClassMapperBase<MediaData> {
  ...
  static const Field<MediaData, String> _f$backdropUrl = Field(
    'backdropUrl',
    _$backdropUrl,
  );
  static String _$posterUrl(MediaData v) => v.posterUrl;
  static const Field<MediaData, String> _f$posterUrl = Field(
    'posterUrl',
    _$posterUrl,
  );
  static List<Country> _$originCountry(MediaData v) => v.originCountry;
  static const Field<MediaData, List<Country>> _f$originCountry = Field(
    'originCountry',
    _$originCountry,
  );
  static String _$originalLanguage(MediaData v) => v.originalLanguage;
  static const Field<MediaData, String> _f$originalLanguage = Field(
    'originalLanguage',
    _$originalLanguage,
  );
  static String _$originalTitle(MediaData v) => v.originalTitle;
  static const Field<MediaData, String> _f$originalTitle = Field(
    'originalTitle',
    _$originalTitle,
  );
  static DateTime? _$premiereDate(MediaData v) => v.premiereDate;
  static const Field<MediaData, DateTime> _f$premiereDate = Field(
    'premiereDate',
    _$premiereDate,
    opt: true,
  );
  ...
  static const Field<MediaData, String> _f$overview = Field(
    'overview',
    _$overview,
  );
  static TMDBRating _$tmdbRating(MediaData v) => v.tmdbRating;
  static const Field<MediaData, TMDBRating> _f$tmdbRating = Field(
    'tmdbRating',
    _$tmdbRating,
  );
  ...
  static const Field<MediaData, List<VideoData>> _f$videos = Field(
    'videos',
    _$videos,
  );
  static int _$userRating(MediaData v) => v.userRating;
  static const Field<MediaData, int> _f$userRating = Field(
    'userRating',
    _$userRating,
  );
  static bool _$isInWatchlist(MediaData v) => v.isInWatchlist;
  static const Field<MediaData, bool> _f$isInWatchlist = Field(
    'isInWatchlist',
    _$isInWatchlist,
  );
  static bool _$isWatched(MediaData v) => v.isWatched;
  static const Field<MediaData, bool> _f$isWatched = Field(
    'isWatched',
    _$isWatched,
  );
  static DateTime? _$watchlistAddedAt(MediaData v) => v.watchlistAddedAt;
  static const Field<MediaData, DateTime> _f$watchlistAddedAt = Field(
    'watchlistAddedAt',
    _$watchlistAddedAt,
    opt: true,
  );
  static DateTime? _$lastWatchedAt(MediaData v) => v.lastWatchedAt;
  static const Field<MediaData, DateTime> _f$lastWatchedAt = Field(
    'lastWatchedAt',
    _$lastWatchedAt,
    opt: true,
  );
